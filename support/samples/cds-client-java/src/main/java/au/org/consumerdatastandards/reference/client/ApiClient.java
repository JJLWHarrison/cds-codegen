 ...
 */
package au.org.consumerdatastandards.reference.client;
...
public class ApiClient {
    ...
    private String basePath = "https://data.provider.com.au/cds-au/v1";
    ...
    public ApiClient() {
        ...
        setUserAgent("cds-client-java/1.0.0");
    }
     ...
     *                 https://data.provider.com.au/cds-au/v1
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams,
        ...
        if (!HttpMethod.permitsRequestBody(method)) {
            ...
            throw new ApiException("application/x-www-form-urlencoded Requests are not supported");
        } else if ("multipart/form-data".equals(contentType)) {
            throw new ApiException("multipart/form-data Requests are not supported");
        } else if (body == null) {
