...
/**
 * The list of available product categories for categorising products and
 * accounts. See [here](#product-categories) for more details
 */
...
public enum BankingEnumProductCategory {
    ...
    public static BankingEnumProductCategory fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<BankingEnumProductCategory> {
        ...
        public BankingEnumProductCategory read(final JsonReader jsonReader) throws IOException {
            ...
            return BankingEnumProductCategory.fromValue(String.valueOf(value));
        }
    }
}
