...
public interface ProductsApi  {
    ...
    public ResponseBankingProductById getProductDetail( @PathParam("productId") String productId,@Context SecurityContext securityContext);
    @GET
    @Path("/products")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    ...
    public ResponseBankingProductList listProducts( @QueryParam("effective") String effective, @QueryParam("updated-since") Date updatedSince, @QueryParam("brand") String brand, @QueryParam("product-category") String productCategory, @QueryParam("page") Integer page, @QueryParam("page-size") Integer pageSize,@Context SecurityContext securityContext);
}
